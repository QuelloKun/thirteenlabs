...
# constants
INFERENCE_CONFIG_PATH = "Models/LibriTTS/config.yml"
INFERENCE_MODEL_PATH = "Models/LibriTTS/epochs_2nd_00020.pth"
REF_STYLE_PATH = "Models/LibriTTS/woman1.wav"
...
if __name__ == "__main__":
    synthesizer = StyleTTS2Inference(
        config_path=INFERENCE_CONFIG_PATH or "Models/LibriTTS/config.yml",
        model_path=INFERENCE_MODEL_PATH or "Models/LibriTTS/epochs_2nd_00020.pth",
    )

    ref_style = synthesizer.compute_style(REF_STYLE_PATH or "Models/LibriTTS/woman1.wav")

    # Generate speech
    audio = synthesizer.inference(text="Hello, how are you doing today?", ref_s=ref_style)

    sf.write(OUTPUT_PATH or "output.wav", audio, 24000)
